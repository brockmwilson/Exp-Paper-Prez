...
To test for dynamic consistency we need rankings to be the same across both periods
...
This next table looks at the relationship between various food groups and 

FIGURE OUT! Maybe skip?
