...
Dynamic Inconsistency arises due to individuals being present biased

--

A simple two period example:

Eating donuts vs going to the gym
...
Action set, $a_t$, is: $(c_t, v_{t+1}) = (0, 1), (-6, 10)$ 
...
- Utility from eating donuts $= \beta*0 + \delta*1 = 0.75$
...
- Chooses eating donuts

--

In period 2:

- Utility from eating donuts $= 0 + \delta*1 = 0.75$
...
This continues as individuals **eat a donut today** and **plan to go to the gym tomorrow**
...
#### To test for dynamic consistency we need estimated $\beta$'s to be the same across both periods
...
This paper uses **unambiguous rankings** for regressions
